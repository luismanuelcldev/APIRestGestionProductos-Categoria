...
const obtenerProductos = async (req, res) => {
    try {
        ...
        // Construir filtros
        const filtros = (0, filtros_1.construirFiltrosProducto)(req);
        ...
        const metadatosPaginacion = (0, paginacion_1.generarMetadatosPaginacion)(totalProductos, opcionesPaginacion);
        logger_1.logger.debug(`Consulta de productos con ${filtros ? Object.keys(filtros).length : 0} filtros - Página ${opcionesPaginacion.pagina}`);
        res.json({
